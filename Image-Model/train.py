...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_scan_dataset = dataset(mode='scan_train' if (args.dataset in ['vigor', 'bdd']) else 'train', print_bool=True, same_area=(not args.cross), args=args)
